            ...
            if (thisTransverseObject.transverseDragging) {
                ...
                if (thisTransverseObject.clickX >= e.pageX) {
                    ...
                    if (
                        ...
                        let child = thisTransverseObject.el.offsetParent;
                        let parent = child.offsetParent;
                        let rate = (child / parent) * 100 + "%";
                        $(thisTransverseObject.el).offset({ left: rate});
                    }
                } else {
                    //鼠标向右移动
                    changeDistance =
                    ...
                    if (
                        ...
                        thisTransverseObject.clickX = e.pageX;
                        console.log(thisTransverseObject);
                        let child = thisTransverseObject.el.offsetParent;
                        let parent = child.offsetParent;
                        let rate = (child / parent) * 100 + "%";
                        $(thisTransverseObject.el).offset({ left: rate});
